...
```{r results='hide'}
sceptre_object <- run_calibration_check(sceptre_object, parallel = F)
```
...
![](images/plot_run_calibration_check-01.png)

-   **Analysis 2**

![](images/plot_run_calibration_check-02.png)

-   **Analysis 3**

![](images/plot_run_calibration_check-03.png)

### Power check

-   **Analysis 1**

![](images/plot_run_power_check.png)

-   **Analysis 2**

![](images/plot_run_power_check-01.png)

-   **Analysis 3**

![](images/plot_run_power_check-02.png)

### Summary

-   [Analysis 1](../output/sceptre_outputs/analysis_summary.txt)
-   [Analysis 2](../output/sceptre_outputs_cis/analysis_summary.txt)
-   [Analysis 3](../output/sceptre_outputs_cis_threshold/analysis_summary.txt)
